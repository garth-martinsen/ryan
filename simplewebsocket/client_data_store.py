...
class DataStore:
    ...
    def translate_message( self, msg: str):
        ...
        if msg =="sd":
            ...
            jmsg=json.loads(msg)
            #TODO 4: Find out what in msg that is breaking json.loads(msg) for the adc sd cmd.
    ...
    def extract_configs(self, message):
        #TODO 3: implement extract_configs(self, message) see test_gui_client for hints how to implement this method
