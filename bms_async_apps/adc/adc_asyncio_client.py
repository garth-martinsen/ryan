...
async def route_msg( msg, writer):
    ...
    # start periodic measurements...        
        ...
        for cnt in range(reps):
            ...
            reps_remaining  -= 1
            print(f"\tFor command 174 reps_remaining: {reps_remaining} of requested reps: {reps}")
    ...
    # many repeated calibrations, same as 174 except type='c' and vin is the truth value.   
        ...
        for cnt in range(reps):
            ...
            await asyncio.sleep(period)
            reps_remaining  -= 1
            print(f"\tFor cmd: 274  the reps_remaining: {reps_remaining} of requested reps: {reps}")
