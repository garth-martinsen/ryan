...
app_config = APP_CONFIG(1, 'GM', 'Development',3,'PCB2',  1784096813.4462662, 25.4, 4.096, 1.024,  32768, 64, 3600, 60, 12.6, 0.05123, 20)
...
bms=[[],[],[],[],[],[]]
bms[0] = BMS(1, 5010, 3, '2026-3-21 20:34:25', 'c', 0,  22654, 2.83175, 0.000316, 4.113, 4.114, -0.001, 64, 2, 62 , 1234,1,1)
bms[1] = BMS(2, 5010, 3, '2026-3-14 19:43:55', 'c', 1,  21036 , 2.629, 0.000239, 7.856, 7.9,  0.0444505, 64,2,62, 1234,1,1 )
bms[2] = BMS(3, 5010, 3, '2026-3-14 19:43:55', 'c', 2,  21036, 2.629, 0.000239, 10.498, 10.5,  -0.002,     64, 2, 62, 1234,1,1)
