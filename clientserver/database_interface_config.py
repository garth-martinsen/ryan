...
#CALIBRATE = namedtuple("CALIBRATE", ("bms_id","vin","error")) No longer needed.
BMS_Columns= ["id", "cfg_id","meas_type", "timestamp", "a2d", "a2d_sd", "vm", "vb", "sample_period", "store_time", "gate_time"]
#db_path ='/Users/garth/Programming/MicroPython/usb/ryan/voltage_divider/data/rt_db'
db_path ='/Users/garth/DIST/clientServer/ryan/clientserver/data/rt_db'
